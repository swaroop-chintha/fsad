    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row items-center justify-center p-4 relative overflow-hidden font-sans">
            ...
            <div className="z-10 flex flex-col-reverse items-center justify-center w-full max-w-5xl md:flex-row relative gap-8 lg:gap-16">
                ...
                <div className="w-full max-w-[450px] p-8 md:p-10 glass-card rounded-[2.5rem] z-10 relative flex flex-col transition-all duration-300 hover:shadow-2xl hover:shadow-indigo-500/10 hover:-translate-y-1">
                    
                    <div className="mb-8 w-full">
                        <h2 className="text-3xl font-bold text-slate-800 mb-2 tracking-tight">
                            Create Account
                        </h2>
                        <p className="text-slate-500 font-medium text-sm">Join EduSub and start learning today.</p>
                    </div>
                    ...
                    <form className="space-y-5 w-full" onSubmit={handleSubmit}>
                        ...
                        <div className="relative group">
                            ...
                            <select
                                ...
                                className="block w-full pl-12 pr-10 py-3.5 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 bg-white/50 hover:bg-white text-slate-900 placeholder-slate-400 font-medium text-[15px] transition-all outline-none shadow-sm appearance-none cursor-pointer"
                                disabled={isSubmitting}
                            >
                        ...
                        <div className="text-sm text-center mt-6 text-slate-500 font-medium">
                            ...
                            <Link to="/login" className="font-bold text-indigo-600 hover:text-indigo-500 hover:underline transition-all ml-1 w-max">
                                Log in
                            </Link>
                        </div>
                    </form>
                ...
                <div className="hidden md:flex flex-col flex-1 justify-center items-start p-8 relative z-0 animate-float text-slate-800">
                    ...
                    <div className="flex items-center gap-3 text-sm font-semibold text-slate-500 uppercase tracking-widest mt-8 border-t border-slate-200/50 pt-8 w-64">
